                            ...
                            <form action="xl_editmanufacture.php?id=<?php echo $id ?>" method="post"
                                ...
                                <div class="control-group">
                                    <form id="Form_upload" method="post" enctype="multipart/form-data">
                                        ...
                                        <td><img class="img-fluid" src='public/images/<?php echo $value['manu_img'] ?>'
                                                alt=""></td>
                                        <div class="controls">
                                            <input type="file" name="fileToUpload" id="fileToUpload">
                                            <?php $_FILES["fileToUpload"]["name"] = $value['manu_img']?>
                                            <img src="../public/images/<?php echo $value['manu_img'] ?>" width="100"><br>
                                        </div>
                                    </form>
